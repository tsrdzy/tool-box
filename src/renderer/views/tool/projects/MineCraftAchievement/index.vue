<template>
    <div id="achievementtool">
        <div class="cards">
            ...
            <div class="card">
                <h2>图标选择:</h2>
                <input v-model="icontypez" v-on:input="icons()" :placeholder="icontype == 's0'
                    ? '请输入物品英文ID'
                    : icontype == 's1'
                        ? '请输入图片路径'
                        : icontype == 's2'
                ...
                <div v-show="icontype == 's0'" class="itemselection">
                    <el-popover placement="left" :hide-after="0" title="Title" :width="500" trigger="click"
            ...
            <div class="card">
                ...
                <select v-model="fonts1" v-on:click="fonts()">
                    ...
                    <option value="Microsoft Yahei" style="font-family: 'Microsoft Yahei'">
                        微软雅黑
                    </option>
            ...
            <div class="card">
                ...
                <!-- <n-color-picker v-model:value="this.stylecolor1" :on-complete="stylecolor()" /> -->
                <input v-model="stylecolor1" v-on:input="stylecolor" type="color">
            </div>
            <div class="card">
                <h2>成就内容:</h2>
                <input v-model="content" type="text" />
                <input v-model="stylecolor2" v-on:input="stylecolor" type="color">
                <!-- <n-color-picker v-model:value="this.stylecolor2" :on-complete="stylecolor()" /> -->
            </div>
        </div>
        <h2 class="title">实时预览</h2>
        <div style="background-color: #77777722; padding: 10px 0; border-radius: 5px">
            <div id="show" class="show">
                <div class="show_1">
                    <div class="show_2">
                        <img v-show="icontype == 's1' || icontype == 's2'" :src="icontypez" alt=" " />
                        <p v-show="icontype == 's0'" :class="'icon-20' + ' ' + icontypez + '-20'"></p>
                        <div>
                            <h2 style="font-family: minecraft; color: rgba(255, 200, 0, 1)" id="h2ss">
                                {{ this.title }}
                            </h2>
                            <h2 style="font-family: minecraft; color: rgba(255, 255, 255, 1)" id="h2ss1">
                                {{ this.content }}
                            </h2>
                        </div>
                    </div>
...
<script>
import mcbox_item_selection from "@/views/tool/projects/MineCraftAchievement/modules/item_selection.vue";
...
export default {
    ...
    mounted() {
        import("@/assets/images/tools/minecraft/1.20.css");
        this.canvas_show();
    },
    methods: {
        canvas_show() {
